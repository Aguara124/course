#ifndef FCSGETPROGRAM_H
#define FCSGETPROGRAM_H
...
class FcsGetProgram : public QObject
{
    Q_OBJECT
public:
    explicit FcsGetProgram(const QString &faculty, QObject *parent = nullptr)
        : QObject{parent}
        , faculty(faculty)
    {}
    ~FcsGetProgram() {}
...
public slots:
    void process()
    {
        ...
        resultList = fcsRepository->getProgram(faculty);
