#ifndef CONSULTATIONASSISTANT_H
#define CONSULTATIONASSISTANT_H
...
class ConsultationTabAssistant : public QWidget
{
    Q_OBJECT
public:
    explicit ConsultationTabAssistant(const QString &assistantLogin, QWidget *parent = nullptr);
    void setupTabLayout();
